...
if __name__ == '__main__':
    ...
    layout = Layout(scene=dict(
        ...
        camera=Camera(
            ...
            eye=dict(x=2, y=2, z=1)  # todo revisit
        ),
    ),
        sliders=[{
            'active': 0,
    ...
    #               marker=dict(color=df['color'].iloc[:k], colorscale='Jet',
    #                           size=6))]) for k in range(0, periods, slice_size)]
    ...
    plot(figure, filename='../output/plotly_3d_sliders.html', auto_open=False)
